<h2><a href="https://practice.geeksforgeeks.org/problems/triplet-sum-in-array-1587115621/1?page=2&status[]=solved&sortBy=submissions">Triplet Sum in Array</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array arr of size n and an integer X. Find if there's a triplet in the array which sums up to the given integer X. </span></p>
