<h2><a href="https://practice.geeksforgeeks.org/problems/remove-all-characters-other-than-alphabets4923/0">Remove all characters other than alphabets</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given a string S,&nbsp;remove all the characters other than the alphabets.</span><br>
<br>
