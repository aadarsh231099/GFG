<h2><a href="https://practice.geeksforgeeks.org/problems/the-penalty-shootout3810/0">The Penalty Shootout</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S contains 0's, 1's, and 2's, the task is to find the number of goals on the penalty.</span></p>
