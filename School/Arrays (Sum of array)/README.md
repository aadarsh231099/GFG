<h2><a href="https://practice.geeksforgeeks.org/problems/c-arrays-sum-of-array-set-14805/0">Arrays (Sum of array)</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of <strong>N</strong> integers. Your task is to print the sum of all of the integers.</span><br>
&nbsp;</p>
